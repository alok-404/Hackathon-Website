        ...
        >
          ...
          <div className="absolute inset-0  cursor-pointer  flex items-center justify-center">
            {/* <div className="w-15 h-16 flex items-center justify-center transition-transform duration-300 group-hover:scale-110 md:w-25 cursor-pointer"> */}
              ...
              <img 
              className="w-15 h-15 flex items-center justify-center transition-transform duration-300 group-hover:scale-110 md:w-25 md:h-25  cursor-pointer" src="https://cdn.iconscout.com/icon/free/png-512/free-youtube-icon-download-in-svg-png-gif-file-formats--logo-play-video-audio-flat-pack-entertainment-icons-1342747.png?f=webp&w=512" alt="" />
            </div>
